...
function generatePassword() {
    ...
    if(passwordLength != null) {
      ...
      if(!useUpperCase && !useLowerCase && !useNumbers && !useSpecialChar) {
        window.alert('No character type selected. Please click on generate password again and select atleast one character type');
      }
